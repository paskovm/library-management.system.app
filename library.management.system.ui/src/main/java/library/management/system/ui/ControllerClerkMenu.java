...
public class ControllerClerkMenu {

    private Stage stage;
    private Scene scene;
    private Parent root;
    @FXML
    private AnchorPane clerkMenuPane;
    ...
    public void checkUserInfo(ActionEvent event) throws IOException {
    ...
    public void exit() throws InterruptedException, IOException {
        ...
        if (alert.showAndWait().get() == ButtonType.OK) {
            stage = (Stage) clerkMenuPane.getScene().getWindow();
