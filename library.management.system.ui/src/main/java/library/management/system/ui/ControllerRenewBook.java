...
public class ControllerRenewBook {
        ...
        if (bookValue.getText() == null || bookValue.getText().isEmpty() || bookValue.getText().isBlank()) {
            ...
            if (book != null) {
                if (book.isIssued()) {
                    ...
                    warningMessage.setHeaderText("This book is no loaned by any user!");
    ...
    public void renewLoan() {
        if (bookToLoan != null && borrower != null) {
            Loan loan = loanService.getLoan(borrower, bookToLoan, false);
            ...
            if (loan != null) {
                ...
                int result = DatabaseInteractions.renewBook(loan);
                if (result > 0) {

                    Alert confirmationMsg = new Alert(Alert.AlertType.CONFIRMATION);
                    confirmationMsg.setTitle("INFO");
                    confirmationMsg.setHeaderText("The loan is renewed successfully!");
                ...
                warningMsg.setHeaderText("The user doesn't have active loan for this book!");
    ...
    public void exit() throws InterruptedException, IOException {
        ...
        if (alert.showAndWait().get() == ButtonType.OK) {
            stage = (Stage) renewBookPane.getScene().getWindow();
