...
public class ControllerListAllIssuedBooks implements Initializable {
    ...
    @FXML
    private AnchorPane listIssuedBooksPane;
    ...
    public void exit() throws InterruptedException, IOException {
        ...
        if (alert.showAndWait().get() == ButtonType.OK) {
            stage = (Stage) listIssuedBooksPane.getScene().getWindow();
