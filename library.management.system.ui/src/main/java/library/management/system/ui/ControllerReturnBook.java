...
public class ControllerReturnBook {
    ...
    public void completeLoan() {
        if (bookToLoan != null && borrower != null) {
            ...
            if (loan != null) {
                loan.setReceiver((Staff) library.getLoggedInPerson());
                ...
                if (result > 0) {
                    ...
                    confirmationMsg.setHeaderText("The user returned the book successfully!");
    ...
    public void exit() throws InterruptedException, IOException {
        ...
        if (alert.showAndWait().get() == ButtonType.OK) {
            stage = (Stage) returnBookPane.getScene().getWindow();
